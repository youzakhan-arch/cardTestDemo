# Motive Product Prototypes

Local HTML prototypes for Motive PM design exploration. Each folder is a self-contained prototype with a live GitHub Pages URL.

## Prototypes

| Prototype | Description | Live |
|---|---|---|
...
Each prototype is a single `index.html` — open the live link or clone and open locally. No build step needed.
